...
const Sidebar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-[290px] min-h-screen h-full pr-0 bg-[#000000] text-white">
      <div className="h-full flex flex-col justify-between  pt-[50px]  drop-shadow">
        ...
        <div className="p-4 mt-auto  text-center">
          <button
            ...
            className=" w-full  text-white  font-semibold px-12 py-3 flex items-center justify-center gap-3 text-md outline-none rounded-full"
          >
