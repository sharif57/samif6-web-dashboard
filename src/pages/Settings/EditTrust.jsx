...
import { useSafetyQuery, useUpdateSafetyMutation } from "../../redux/features/privacySlice";
...
const EditTrust = () => {
  ...
  const { data, isLoading, error } = useSafetyQuery();
  ...
  const handleupdateTerms = async () => {
    try {
      ...
      await updateSafety(privacyData).unwrap();
  ...
  return (
    <div className="p-6">
      <div onClick={handleBack} className="flex cursor-pointer items-center gap-2 text-xl text-white mb-8">
        <button
          onClick={handleBack}
        ...
        <div className="space-y-[24px] min-h-[83vh]  rounded-2xl p-8">
          ...
          <div className="w-full">
            <div className="h-full rounded-md">
              <ReactQuill
                placeholder="Enter your updated terms & safety..."
                theme="snow"
                value={content}
