...
// import { useAllSubscriptionQuery } from "../../../redux/features/subscriptionSlice";

// export default function Subscription() {
//   const {data} = useAllSubscriptionQuery();
...
//         {
//           data?.data?.map((item) => (
//             <div key={item.id} className="bg-[#404040] rounded-3xl h-[600px] p-6  flex flex-col ">
...
export default function Subscription() {
  const { data, isLoading, error } = useAllSubscriptionQuery();
